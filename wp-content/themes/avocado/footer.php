        ...
        <div class="container">
            <div class="footer__content">
                <div class="footer__item">
                    ...
                    <div class="footer__text"><?php the_field('instagram') ?></div>
                </div>
                <div class="footer__item">
                    <img class="icon" src="<?php echo bloginfo('template_url'); ?>/assets/icons/location.svg" alt="location">
                    <div class="footer__text"><?php the_field('address') ?></div>
                </div>
                <div class="footer__item">
                    <img class="icon" src="<?php echo bloginfo('template_url'); ?>/assets/icons/phone.svg" alt="phone">
                    <div><div class="footer__text"><?php the_field('phone_1') ?></div>
                    <div class="footer__text"><?php the_field('phone_2') ?></div></div>
                </div>
                <div class="footer__item">
